...
# https://github.com/roddhjav/apparmor.d/blob/main/apparmor.d/groups/ssh/sshd
''
  abi <abi/4.0>,

  include <tunables/global>

  @{exec_path} = ${pkgs.openssh}/bin/sshd
  profile sshd @{exec_path} flags=(attach_disconnected) {
    ...
    @{sbin}/nologin                    Px,
    @{bin}/passwd                      Px,
    ${pkgs.openssh}/libexec/sftp-server   Px,
    ${pkgs.openssh}/libexec/sshd-auth     Px,
    ${pkgs.openssh}/libexec/sshd-session  Px,
